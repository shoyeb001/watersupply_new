...
<head>
  <meta charset="utf-8">
    ...
    <title>Ecommerce Admin Invoice - Log in </title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
		@php 
		 if (isset($_COOKIE['admin2_email']) && isset($_COOKIE['admin2_password'])) {
			 $email = $_COOKIE['admin2_email'];
			 $password = $_COOKIE['admin2_password'];
		 }else {
			 $email = "";
			 $password="";
		 }
		@endphp
 <form method="POST" action="{{route("admin2.login")}}">
            @csrf 
