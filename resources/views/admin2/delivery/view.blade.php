...
<div id="page-content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card card-boy shadow m-2">
            <div class="card-body">
                <p>#{{$item->order_id}}</p>
                <h4 class="fw-bold">Name : {{$item->customer_name}}</h4>
                <p>Phone No : +91 {{$item->phone_no}}</p>
                <p>Address : {{$item->full_address}}, {{$item->state}} - {{$item->pin_no}}</p>
                <div class="row">
                    <div class="col-lg-8 col-sm-12 col-md-8">
                        ...
                        <h6 class="p-1">
                            Product :
                            <span class="badge bg-info">{{$item->product->product_title}}</span>
                        </h6>
