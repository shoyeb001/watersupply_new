      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{asset("admin2.logout")}}">
        ...
        <div class="container-fluid">
                    ...
                    <table class="table table-borderless">
                      <tbody>
                        ...
                        <tr class="content-bill">
                          ...
                          <td class="text-center">{{number_format((float)  $order[0]->price * $order[0]->quantity, 2)}}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
          ...
          <div class="row">
            <div class="col p-2 card-back">
                <center>
                <a href="{{route("online.invoice.view", $order[0]->id)}}"> <i class="fa fa-solid fa-print icon-bottom"></i> </a>
                <a href="{{route("online.invoice.view", $order[0]->id)}}"> <i class="fa fa-solid fa-download icon-bottom"></i></a>
